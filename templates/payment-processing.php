<div id="rpress-payment-processing">
	<p><?php printf( __( 'Your purchase is processing. This page will reload automatically in 8 seconds. If it does not, click <a href="%s">here</a>.', 'restro-press' ), rpress_get_success_page_uri() ); ?>
