...
if ( ! is_user_logged_in() ) :
	...
	<form id="rpress_login_form" class="rpress_form" action="" method="post">
		<fieldset>
			<legend><?php _e( 'Log into Your Account', 'restro-press' ); ?></legend>
			<?php do_action( 'rpress_login_fields_before' ); ?>
			<p class="rpress-login-username">
				<label for="rpress_user_login"><?php _e( 'Username or Email', 'restro-press' ); ?></label>
			...
			<p class="rpress-login-password">
				<label for="rpress_user_pass"><?php _e( 'Password', 'restro-press' ); ?></label>
			...
			<p class="rpress-login-remember">
				<label><input name="rememberme" type="checkbox" id="rememberme" value="forever" /> <?php _e( 'Remember Me', 'restro-press' ); ?></label>
			</p>
			<p class="rpress-login-submit">
				...
				<input type="submit" class="rpress-submit <?php echo $color; ?> <?php echo $style; ?>" id="rpress_login_submit"  value="<?php _e( 'Log In', 'restro-press' ); ?>"/>
			</p>
