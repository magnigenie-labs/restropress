 ...
 * Description: RestroPress is an online food ordering system for WordPress which helps to grow your restraunt business online.
 * Author: Magnigenie
...
final class RestroPress {
	...
	public function __clone() {
		...
		_doing_it_wrong( __FUNCTION__, __( 'Cheatin&#8217; huh?', 'restropress' ), '1.6' );
	}
	...
	public function load_textdomain() {
		load_plugin_textdomain( 'restropress', false, dirname( plugin_basename( __FILE__ ) ). '/languages/' );
	}
