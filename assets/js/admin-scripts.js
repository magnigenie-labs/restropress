jQuery(document).ready(function ($) {
	...
	var RPRESS_Edit_Payment = {
		...
		remove_fooditem : function() {
			...
			$('#rpress-purchased-files').on('click', '.rpress-order-remove-fooditem', function() {

				var count = $( document.body ).find( '#rpress-purchased-files > .row:not(.header)' ).length;
		...
		add_fooditem : function() {
			...
			$('.rpress-edit-purchase-element').on('click', '#rpress-order-add-fooditem', function(e) {
				...
				var count = $('#rpress-purchased-files div.row').length;
		...
		edit_qty: function() {
			$(document.body).on('change keyup', '.rpress-payment-details-fooditem-quantity', function() {
				...
				var row = $(this).parents('ul.rpress-purchased-files-list-wrapper');
		...
		recalculate_total : function() {
			...
			$('#rpress-order-recalc-total').on('click', function(e) {
				...
				var total  = 0,
					tax    = 0,
					totals = $('#rpress-purchased-files .row input.rpress-payment-details-fooditem-amount'),
					taxes  = $('#rpress-purchased-files .row input.rpress-payment-details-fooditem-item-tax');
