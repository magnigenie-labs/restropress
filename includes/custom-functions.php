...
function get_delivery_options() {
	if( rpress_get_option('enable_delivery') == 1 || rpress_get_option('enable_pickup') == 1 ) {
		...
		$html = '';
		$html .= '<h3 class="delivery-options-heading">'. __( 'Delivery Options', 'restropress' ).'</h3>';
		$html .='<div class="delivery-wrap">';
		$html .='<div class="delivery-opts">';
		
		if( rpress_get_option('enable_delivery') == 1 ) :
			
			$html .='<input class="deli" id="delivery" type="radio" checked="checked" value="delivery" name="delivery_opt"><label for="delivery">'.__( 'Delivery', 'restropress' ).'</label>'
	  			;
		endif;

		if( rpress_get_option('enable_pickup') == 1 ) : 
			
			$html .='<input class="pick" id="pickup" type="radio" value="pickup" name="delivery_opt"><label for="pickup">'.__( 'Pickup', 'restropress' ).'</label>'
	  			;
		endif;
		$html .='</div>';
		
		$html .='<div class="rpress-open-hrs">';
		$html .= '<h3 class="delivery-options-heading">'.__( 'Select Delivery / Pickup Time', 'restropress' ).'</h3>';
...
?>
	<p id="rpress-phone-wrap">
  	<label class="rpress-label" for="rpress-phone"><?php _e('Phone Number', 'restropress'); ?></label>
    ...
    <p id="rpress-door-flat">
  	<label class="rpress-flat" for="rpress-flat"><?php _e('Door/Flat No.', 'restropress'); ?></label>
    <span class="rpress-description">
    ...
    <p id="rpress-landmark">
  	<label class="rpress-landmark" for="rpress-landmark"><?php _e('Land Mark', 'restropress') ?></label>
    <span class="rpress-description">
