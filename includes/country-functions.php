...
function rpress_get_spain_states_list() {
	$states = array(
		''   => '',
	    'C'  => __( 'A Coru&ntilde;a', 'restro-press' ),
	    'VI' => __( 'Araba', 'restro-press' ),
	    'AB' => __( 'Albacete', 'restro-press' ),
	    'A'  => __( 'Alicante', 'restro-press' ),
	    'AL' => __( 'Almer&iacute;a', 'restro-press' ),
	    'O'  => __( 'Asturias', 'restro-press' ),
	    'AV' => __( '&Aacute;vila', 'restro-press' ),
	    'BA' => __( 'Badajoz', 'restro-press' ),
	    'PM' => __( 'Baleares', 'restro-press' ),
	    'B'  => __( 'Barcelona', 'restro-press' ),
	    'BU' => __( 'Burgos', 'restro-press' ),
	    'CC' => __( 'C&aacute;ceres', 'restro-press' ),
	    'CA' => __( 'C&aacute;diz', 'restro-press' ),
	    'S'  => __( 'Cantabria', 'restro-press' ),
	    'CS' => __( 'Castell&oacute;n', 'restro-press' ),
	    'CE' => __( 'Ceuta', 'restro-press' ),
	    'CR' => __( 'Ciudad Real', 'restro-press' ),
	    'CO' => __( 'C&oacute;rdoba', 'restro-press' ),
	    'CU' => __( 'Cuenca', 'restro-press' ),
	    'GI' => __( 'Girona', 'restro-press' ),
	    'GR' => __( 'Granada', 'restro-press' ),
	    'GU' => __( 'Guadalajara', 'restro-press' ),
	    'SS' => __( 'Gipuzkoa', 'restro-press' ),
	    'H'  => __( 'Huelva', 'restro-press' ),
	    'HU' => __( 'Huesca', 'restro-press' ),
	    'J'  => __( 'Ja&eacute;n', 'restro-press' ),
	    'LO' => __( 'La Rioja', 'restro-press' ),
	    'GC' => __( 'Las Palmas', 'restro-press' ),
	    'LE' => __( 'Le&oacute;n', 'restro-press' ),
	    'L'  => __( 'Lleida', 'restro-press' ),
	    'LU' => __( 'Lugo', 'restro-press' ),
	    'M'  => __( 'Madrid', 'restro-press' ),
	    'MA' => __( 'M&aacute;laga', 'restro-press' ),
	    'ML' => __( 'Melilla', 'restro-press' ),
	    'MU' => __( 'Murcia', 'restro-press' ),
	    'NA' => __( 'Navarra', 'restro-press' ),
	    'OR' => __( 'Ourense', 'restro-press' ),
	    'P'  => __( 'Palencia', 'restro-press' ),
	    'PO' => __( 'Pontevedra', 'restro-press' ),
	    'SA' => __( 'Salamanca', 'restro-press' ),
	    'TF' => __( 'Santa Cruz de Tenerife', 'restro-press' ),
	    'SG' => __( 'Segovia', 'restro-press' ),
	    'SE' => __( 'Sevilla', 'restro-press' ),
	    'SO' => __( 'Soria', 'restro-press' ),
	    'T'  => __( 'Tarragona', 'restro-press' ),
	    'TE' => __( 'Teruel', 'restro-press' ),
	    'TO' => __( 'Toledo', 'restro-press' ),
	    'V'  => __( 'Valencia', 'restro-press' ),
	    'VA' => __( 'Valladolid', 'restro-press' ),
	    'BI' => __( 'Bizkaia', 'restro-press' ),
	    'ZA' => __( 'Zamora', 'restro-press' ),
	    'Z'  => __( 'Zaragoza', 'restro-press' )
	);
