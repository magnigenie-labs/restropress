...
class RPRESS_Batch_RestroPress_Export extends RPRESS_Batch_Export {
	...
	public function csv_cols() {
		...
		$cols = array(
			...
			'post_name'                => __( 'Slug',   'restro-press' ),
			'post_title'               => __( 'Name',   'restro-press' ),
			'post_date'                => __( 'Date Created',   'restro-press' ),
			'post_author'              => __( 'Author',   'restro-press' ),
			'post_content'             => __( 'Description',   'restro-press' ),
			'post_excerpt'             => __( 'Excerpt',   'restro-press' ),
			'post_status'              => __( 'Status',   'restro-press' ),
			'categories'               => __( 'Categories',   'restro-press' ),
			'tags'                     => __( 'Tags',   'restro-press' ),
			'rpress_price'                => __( 'Price',   'restro-press' ),
			'_rpress_files'               => __( 'Files',   'restro-press' ),
			'_rpress_fooditem_limit'      => __( 'File RestroPress Limit',   'restro-press' ),
			'_thumbnail_id'            => __( 'Featured Image',   'restro-press' ),
			'rpress_sku'                  => __( 'SKU',   'restro-press' ),
			'rpress_product_notes'        => __( 'Notes',   'restro-press' ),
			'_rpress_fooditem_sales'      => __( 'Sales',   'restro-press' ),
			'_rpress_fooditem_earnings'   => __( 'Earnings',   'restro-press' ),
		);
