...
class RPRESS_Batch_Payments_Export extends RPRESS_Batch_Export {
	...
	public function csv_cols() {
		$cols = array(
			'id'           => __( 'Payment ID',   'restro-press' ), // unaltered payment ID (use for querying)
			...
			'products'     => __( 'Products (Verbose)', 'restro-press' ),
			'products_raw' => __( 'Products (Raw)', 'restro-press' ),
			...
			'mode'         => __( 'Mode (Live|Test)', 'restro-press' ),
			'status'       => __( 'Status', 'restro-press' ),
			'country_name' => __( 'Country Name', 'restro-press' ),
		);
