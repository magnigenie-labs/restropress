					...
					<ul id="rpress-item-tab-wrapper-list" class="customer-tab-wrapper-list">
						<?php foreach ( $customer_tabs as $key => $tab ) : ?>
							...
							<li class="<?php echo sanitize_html_class( $class ); ?>">
								...
								<?php if ( ! $active ) : ?>
									<a href="<?php echo esc_url( admin_url( 'edit.php?post_type=fooditem&page=rpress-customers&view=' . $key . '&id=' . $customer->id . '#wpbody-content' ) ); ?>"<?php echo $aria_label; ?>>
								<?php endif; ?>
...
function rpress_customers_view( $customer ) {
	...
	<div class="info-wrapper customer-section">
		...
		<form id="edit-customer-info" method="post" action="<?php echo admin_url( 'edit.php?post_type=fooditem&page=rpress-customers&view=overview&id=' . $customer->id ); ?>">
					...
					<?php foreach ( $all_emails as $key => $email ) : ?>
						<tr data-key="<?php echo $key; ?>">
							...
							<td>
								<?php if ( 'primary' !== $key ) : ?>
									<?php
										$base_url    = admin_url( 'edit.php?post_type=fooditem&page=rpress-customers&view=overview&id=' . $customer->id );
...
function rpress_customer_notes_view( $customer ) {
	...
	<div id="rpress-item-notes-wrapper">
		...
		<div style="display: block; margin-bottom: 35px;">
			<form id="rpress-add-customer-note" method="post" action="<?php echo admin_url( 'edit.php?post_type=fooditem&page=rpress-customers&view=notes&id=' . $customer->id ); ?>">
...
function rpress_customers_delete_view( $customer ) {
	...
	<div class="info-wrapper customer-section">
		...
		<form id="delete-customer" method="post" action="<?php echo admin_url( 'edit.php?post_type=fooditem&page=rpress-customers&view=delete&id=' . $customer->id ); ?>">
