              ...
              <?php foreach( $get_addons as $get_addon ) :
                ...
                if( rpress_has_variable_prices( $post_id ) ) {
                  ...
                  $default_var_selected ='';
                    ...
                    <tr class="rp-child-addon">
                      ...
                      <td class="addon_price"><input class="addon-custom-price" type="text" placeholder="0.00" value="<?php echo rpress_sanitize_amount( $addon_price ); ?>" name="addons[<?php echo sanitize_key( $key ); ?>][prices][<?php echo sanitize_key( $addon_item_id ); ?>][<?php echo sanitize_key( $price['name'] ); ?>]"></td>
                ...
                <?php } else {
                  ...
                  <tr class="rp-child-addon">
                    ...
                    <td class="addon_price"><input class="addon-custom-price" type="text" placeholder="0.00" value="<?php echo rpress_sanitize_amount( $addon_price ); ?>" name="addons[<?php echo sanitize_key( $key ); ?>][prices][<?php echo sanitize_key( $addon_item_id ); ?>]"></td>
