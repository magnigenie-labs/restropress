...
class RPRESS_API_Keys_Table extends WP_List_Table {
	...
	public function __construct() {
		...
		parent::__construct( array(
			'singular'  => __( 'API Key', 'restropress' ),
			'plural'    => __( 'API Keys', 'restropress' ),
			'ajax'      => false,
		) );
	...
	public function get_columns() {
		$columns = array(
			'user'   => __( 'Username', 'restropress' ),
			'key'    => __( 'Public Key', 'restropress' ),
			'token'  => __( 'Token', 'restropress' ),
			'secret' => __( 'Secret Key', 'restropress' ),
		);
	...
	public function bulk_actions( $which = '' ) {
		...
		<form id="api-key-generate-form" method="post" action="<?php echo admin_url( 'admin.php?page=rpress-tools&tab=api_keys' ); ?>">
			...
			<?php submit_button( __( 'Generate New API Keys', 'restropress' ), 'secondary', 'submit', false ); ?>
		</form>
		<?php
