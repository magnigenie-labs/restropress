 ...
 * for almost all endpoints in Restropress REST API.
 *
 ...
 * @version  2.6.0
 */
abstract class RP_REST_Controller extends WP_REST_Controller {
    ...
    protected function add_additional_fields_schema( $schema ) {
        ...
        $schema[ 'properties' ] = apply_filters( 'restropress_rest_' . $object_type . '_schema', $schema[ 'properties' ] );
    ...
    protected function check_batch_limit( $items ) {
        ...
        if ( $total > $limit ) {
            ...
            return new WP_Error( 'woocommerce_rest_request_entity_too_large', sprintf( __( 'Unable to accept more than %s items for this request.', 'rpress' ), $limit ), array( 'status' => 413 ) );
        }
    ...
    public function validate_setting_select_field( $value, $setting ) {
        if ( array_key_exists( $value, $setting[ 'options' ] ) ) {
            ...
            return new WP_Error( 'rest_setting_value_invalid', __( 'An invalid setting value was passed.', 'rpress' ), array( 'status' => 400 ) );
        }
    }
    ...
    public function get_public_batch_schema() {
        $schema = array(
            ...
            'properties' => array(
                'create' => array(
                    'description' => __( 'List of created resources.', 'rpress' ),
                    'type' => 'array',
                ...
                'update' => array(
                    'description' => __( 'List of updated resources.', 'rpress' ),
                    'type' => 'array',
                    'context' => array( 'view', 'edit' ),
                    'items' => array(
                        'type' => 'object',
                ...
                'delete' => array(
                    'description' => __( 'List of delete resources.', 'rpress' ),
                    'type' => 'array',
                    'context' => array( 'view', 'edit' ),
                    'items' => array(
                        'type' => 'integer',
